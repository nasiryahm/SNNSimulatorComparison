...
ax.plot([0, 8], [SpikeBenchmark, SpikeBenchmark], color='r', linewidth = 5, alpha=0.5, zorder=1)
ax.plot(points, expfunc(points, *popt), color='b', linewidth = 5, alpha=0.5, zorder=1)
